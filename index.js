...
function setupTabContent(container) {
  ...
  function init() {
    ...
    tl.to(cardsContainerEl.children, {
      ...
      .to(
        cardInfosContainerEl.querySelector(".current--info").querySelectorAll(
          ".text"
        ),
        {
          delay: 0.5,
...
function toggleVisibility(elementSelector) {
  ...
  if (rect.top < window.innerHeight && rect.bottom > 0) {
    ...
    if (!element.classList.contains("fromright") && !element.classList.contains("fromleft")) {
...
function toggleVisibility(elementSelector) {
  ...
  if (rect.top < window.innerHeight && rect.bottom > 0) {
    ...
    if (!element.classList.contains("scaleup") && !element.classList.contains("hidden")) {
...
if (window.innerWidth < 991) {
  ...
  touchmode.addEventListener('touchend', function(ev){
      ...
      touchmode.style.opacity = ".7";
  
  })
  
  touchmode.addEventListener('touchstart', function(ev){
  ...
  touchmode2.addEventListener('touchmove', function(ev){
      ...
      touchmode2.style.top = touchLocation.clientY -30 + 'px';
  
  })
  
  touchmode2.addEventListener('touchend', function(ev){
  
      var x = parseInt(touchmode2.style.left);
      var y = parseInt(touchmode2.style.top);
